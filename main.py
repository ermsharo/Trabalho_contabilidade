...
# best_portfolio(generate_wallets(generate_df_closed()))
generated_closed_df = generate_df_closed()
# print("\n \n genarated closed dataframe \n ", generated_closed_df)
generated_wallets = generate_wallets(generated_closed_df)
# print(" \n \n genarated wallets", generated_wallets)
best_port = best_portfolio(generated_wallets)
print(" \n \n best portfolio", best_port)
plot_efficient_frontier(generated_wallets)